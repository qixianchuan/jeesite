...
<head>
	...
	<style type="text/css">
      ...
      .form-signin{position:relative;text-align:left;width:300px;padding:25px 29px 29px;margin:0 auto 20px;border:1px solid #e5e5e5;
	...
	<script src="${ctxStatic}/login/js/jquery-1.8.2.min.js"></script>
...
<body>
	...
	<div class="page-container">
		<h1 class="form-signin-heading">${fns:getConfig('productName')}</h1>
            <form id="loginForm" class="form-signin center-block" action="${ctx}/login" method="post">
	...
	<%--<script src="${ctxStatic}/login/js/scripts.js"></script>--%>
</body>
</html>
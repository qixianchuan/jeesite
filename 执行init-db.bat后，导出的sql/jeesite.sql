...
CREATE TABLE `cms_article_data` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文章详表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='生成方案';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='业务表字段';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='代码模板表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='请假流程表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='通知通告';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='通知通告发送记录';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='审批流程测试表';
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', '1', '2', 'thinkgem', '02a3f0772fcca9f415adc990734b45c6f059c7d33ee28362c4852032', '0001', '系统管理员', 'thinkgem@163.com', '8675', '8675', null, null, null, null, '1', '1', '2013-05-27 08:00:00', '1', '2013-05-27 08:00:00', '最高管理员', '0');
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='业务数据表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='业务数据子表';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='树结构表';
